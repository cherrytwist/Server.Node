...
import { VerifiedCredential } from '@services/platform/ssi/agent';
import stateModificationMetadata from '@services/platform/ssi/credentials/StateModificationCredentialMetaData';
